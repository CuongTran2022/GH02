...
function molla_quickview_html( $type = '' ) {
	...
	echo apply_filters( 'molla_woocommerce_quickview_html', '<a href="#" class="btn-product' . esc_attr( $type ) . ' btn-quickview" data-product-id="' . (int) $product->get_id() . '" title="Xem nhanh">' . $label . '</a>', $type );
}
