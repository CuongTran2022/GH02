		...
		<div class="row">
			<div class="col-lg-5 mb-4">
				...
				<figure class="vendor-banner br-5 overflow-hidden">
					<?php echo apply_filters( 'molla_lazy_load_images', wp_get_attachment_image( $banner, 'full' ) ); ?>
				</figure>
				<?php endif; ?>
			</div>
			...
			<div class="col-lg-7 pl-lg-6 mb-4">
				...
				<ul class="list-unstyled list sp-vendor-info">
					...
					<li class="store-name">
						<span><?php esc_html_e( 'Store Name:', 'molla' ); ?></span>
						<span class="details">
					...
					<li class="store-address">
						<span><?php esc_html_e( 'Address:', 'molla' ); ?></span>
						<span class="details">
					...
					<li class="store-email">
						<span><?php echo esc_html_e( 'Email:', 'molla' ); ?></span>
						<span class="details">
					...
					<li class="store-phone">
						<span><?php echo esc_html_e( 'Phone:', 'molla' ); ?></span>
						<span class="details">
				...
				<a href="<?php echo esc_url( $store_url ); ?>" class="btn btn-link btn-underline"><?php esc_html_e( 'Visit Store', 'molla' ); ?><i class="w-icon-long-arrow-<?php echo is_rtl() ? 'left' : 'right'; ?>"></i></a>
			</div>
		</div>
		<?php

		if ( $wcfm_shop_description ) {
			echo '<div class="vendor-description pt-3 pb-3">' . molla_strip_script_tags( $wcfm_shop_description ) . '</div>';
		}
