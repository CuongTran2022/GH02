...
@media screen and (max-width: 480px) {
	#wcfmmp-store .header_right {
		background: <?php echo molla_filter_output( $mob_wcfmmp_header_background_color ); ?>;
	}
}
</style>		
...
<div id="wcfmmp-store" class="wcfmmp-single-store-holder <?php echo molla_filter_output( $wcfm_store_wrapper_class ); ?>">
