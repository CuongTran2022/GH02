...
class Molla_Elementor {
	...
	public function __construct() {
		...
		// Controls Partials
		require_once( MOLLA_CORE_DIR . 'elementor/partials/product.php' );
		require_once( MOLLA_CORE_DIR . 'elementor/partials/banner.php' );
		require_once( MOLLA_CORE_DIR . 'elementor/partials/grid.php' );
		...
		require_once( MOLLA_CORE_DIR . 'elementor/tabs_advanced/molla_widget_advanced_tabs.php' );
	...
	public function elementor_scripts() {
		...
		wp_register_script( 'molla-elementor-widgets-js', MOLLA_CORE_JS . 'elementor.js', array(), false, true );
