...
class CouponPageMoved {
	...
	public static function get_note() {
		$note = new Note();
		$note->set_title( __( 'Quản lý phiếu ưu đãi đã được chuyển!', 'woocommerce' ) );
		$note->set_content( __( 'Phiếu giảm giá hiện có thể được quản lý từ Tiếp thị > Các ưu đãi. Nhấp vào nút bên dưới để xóa mục menu WooCommerce > mục phiếu ưu đãi.', 'woocommerce' ) );
		...
		$note->add_action(
			...
			__( 'Xóa menu phiếu ưu đãi', 'woocommerce' ),
